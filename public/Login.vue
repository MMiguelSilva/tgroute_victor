    ...
    async acessoUsuario() {
      try {
        ...
        if (this.email.trim().toUpperCase() != "MASTER@ACMTRACKER.COM.BR") {
          ...
          const senhaMaster = "jat@" + funcoes.retornaDataHoraAtual("DMA", "");
          senhaRetorno = funcoes.converteTextoToHex(senhaMaster);
          emailRetorno = "MASTER@ACMTRACKER.COM.BR";

          senhaCodec = funcoes.converteTextoToHex(this.senha);
        }
        ...
        if (
          ...
          if (this.email.trim().toUpperCase() == "SAC@ACMTRACKER.COM.BR" | this.email.trim().toUpperCase() == "ATENDENTE@ACMAUTOMACAO.COM.BR") {
            localStorage.tipoCaminho = this.tipoCaminho;
          }
         ...
         if (
            (this.email.trim().toUpperCase() == "SAC@ACMTRACKER.COM.BR") |
            (this.email.trim().toUpperCase() == "ATENDENTE@ACMAUTOMACAO.COM.BR") |
            (this.email.trim().toUpperCase() == "MASTER@ACMTRACKER.COM.BR")
          ) {
            //acessa a tela lista de clientes
            this.avisoErro = "";
            this.$destroy();
